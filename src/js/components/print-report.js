...
const hypothesisStatus = hypothesis => {
  if (['prioritized', 'green', 'yellow'].includes(hypothesis.status)) return ['prioritized', 'PRIORITIZE ★'];
  return ['', 'UNCHECKED'];
};
